                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          <div className="flex items-center gap-2">
                            <h3 className="font-extrabold text-xl sm:text-2xl text-gray-900 leading-tight">{item.name}</h3>
                            {isLowStock && (
                        ...
                        <div className="text-right flex flex-col items-end gap-1">
                          <div className="font-bold text-blue-700 bg-blue-50 px-3 py-1.5 rounded-lg text-lg sm:text-xl shadow-sm border border-blue-100">
                            {formatPieces(stockPieces, item.piecesPerUnit, item.unitMeasurement)}
                          </div>
                          <div className="text-xs sm:text-sm font-bold text-gray-600 bg-gray-100 px-2 py-0.5 rounded uppercase tracking-wider">{stockPieces} Total Pcs</div>
                        </div>
                      </div>
                            ...
                            <div className="mt-2 flex flex-col gap-1.5 bg-gray-50 rounded-lg p-2.5 border border-gray-100 shadow-inner">
                              ...
                              {getItemBatches(item.id, transactions).length === 0 ? (
                                ...
                                getItemBatches(item.id, transactions).map(batch => (
                                  <div key={batch.id} className="flex justify-between items-center bg-white p-2 border border-gray-200 rounded shadow-sm mb-1">
